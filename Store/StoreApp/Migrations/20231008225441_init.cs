    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "03abb42e-4880-4fa8-8981-3c6ec1caa51f", "217f61d9-12db-4177-837e-39f6c321dba3", "Editor", "EDITOR" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "05d682fc-990f-44a9-9b38-53e3ff7aa671", "32131a9a-9448-4e37-bb96-ba280a317b7c", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "3173baea-2ef7-42f8-b28c-f8518e35893f", "79a48b5b-eb67-4d4d-adf5-4d12ef1ce192", "User", "USER" });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ImageUrl", "Price", "ProductName", "ShowCase", "Summary" },
                values: new object[] { 5, 1, "/images/5.jpg", 17000m, "History", false, "" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ImageUrl", "Price", "ProductName", "ShowCase", "Summary" },
                values: new object[] { 6, 1, "/images/6.jpg", 17000m, "Hamlet", false, "" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ImageUrl", "Price", "ProductName", "ShowCase", "Summary" },
                values: new object[] { 7, 2, "/images/7.jpg", 1150m, "Xp-Pen", true, "" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ImageUrl", "Price", "ProductName", "ShowCase", "Summary" },
                values: new object[] { 8, 1, "/images/8.jpg", 4445m, "Samsung Galaxy FE", true, "" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "ImageUrl", "Price", "ProductName", "ShowCase", "Summary" },
                values: new object[] { 9, 2, "/images/9.jpg", 877m, "Wordpress ENVATO Theme", true, "" });
