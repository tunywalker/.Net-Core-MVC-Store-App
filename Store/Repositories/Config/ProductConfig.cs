...
namespace Repositories.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
                ...
                new Product() { ProductId = 5, CategoryId = 1,ImageUrl="/images/5.jpg", ProductName = "History", Price = 17_000 },
                new Product() { ProductId = 6, CategoryId = 1,ImageUrl="/images/6.jpg", ProductName = "Hamlet", Price = 17_000 }
